				...
				<section class="seccion">
					<div class="contenedor-section">
						<div class="titulo-incial">
							<h1>Guías para el Hogar</h1>
						</div>
						 <%
							Guia g = new Guia();
						 	List<String> titulo=g.consultarGuiasTitulo(1);
						 	List<String> content=g.consultarGuiasContenido(1);
						 	List<String> imagen=g.consultarGuiasImagen(1);
						 	int cont=0;
						 	if(content.isEmpty()){
				           ...
				           <% 
				                 ...
				                 /*texto.split("(?=\\d+\\.\\s)");*/
				                 /*texto.split("(?<=\\d\\.\\s)");*/
					            // Iterar sobre cada sección y agregarla al contenido
