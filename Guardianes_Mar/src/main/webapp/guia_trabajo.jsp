				...
				<section class="seccion">
					<div class="contenedor-section">
						<div class="titulo-incial">
							<h1>Guías para el trabajo</h1>
						</div>
						<%
							Guia g = new Guia();
						 	List<String> titulo=g.consultarGuiasTitulo(3);
						 	List<String> content=g.consultarGuiasContenido(3);
						 	List<String> imagen=g.consultarGuiasImagen(3);
						 	int cont=0;
						 	if(content.isEmpty()){
